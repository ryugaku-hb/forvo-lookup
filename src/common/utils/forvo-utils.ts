...
/**
 * 判断是否为受支持的语言代码
 * @param langCode 待验证的语言代码
 * @example
 * isValidLangCode("en") // true
 * isValidLangCode("xx") // false
 */
export function isValidLangCode(
  langCode: string
...
class InvalidUrlError extends Error {
  /**
   *
   * @param service 服务名称，如 `"Forvo"`
   * @param url 被检测的 URL 字符串
   */
 ...
 */
export function extractLangCode(forvoUrl: string): SupportedLangCode {
 ...
 */
export function getForvoBaseUrlBySubdomain(
 ...
 */
export function getAllForvoBaseUrls(): string[] {
